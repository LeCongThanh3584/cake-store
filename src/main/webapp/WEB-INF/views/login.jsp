    ...
    <div class="container my-5">
        <div class="row d-flex justify-content-center">
            <div class="col-lg-6 col-md-9 col-sm-12">
                <form class="card px-5 py-5" action="/login" method="post">
                    <div class="form-data">
                        <h2 class="text-center font-weight-bold my-3 mb-4">Login Form</h2>
                    ...
                    <div class="form-group mt-2">
                        <label for="exampleInputPassword" class="font-weight-bold text-secondary">Password</label>
                    ...
                    <div class="mt-3 d-flex justify-content-center">
                        ...
                        <a href="/forgot-password" class="ml-2">forgot password</a>
                    </div>
                </form>
            </div>
        </div>
