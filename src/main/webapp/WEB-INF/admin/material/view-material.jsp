    ...
    <div>
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item fs-5 active">View materials</li>
            </ol>
        </nav>
    </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <h3 class="card-title fs-3">List of materials</h3>
                            <a href="/admin/material/create" class="btn btn-success text-white"><i
                                    class="bi bi-file-earmark-plus">Add material</i></a>
                        </div>
                        <div class="datatable-top">
                            <form class="datatable-search text-end" action="/admin/material/view">
                        ...
                        <table class="table datatable">
                            ...
                            <tbody>
                            <c:forEach items="${materials}" var="mt" varStatus="i">
                                <tr>
                                    <td>${i.index + 1}</td>
                                    <td>${mt.code}</td>
                                    <td>${mt.name}</td>
                                    ...
                                    <td>
                                        <a class="btn btn-primary"
                                           href="/admin/material/update?id=${mt.id}"><i
                                                class="bi bi-pencil-square"></i></a>
                                        <a class="btn btn-danger" href="#"
                                           onclick="confirmDeletion('/admin/material/delete?id=${mt.id}')">
                                    ...
                                    <c:if test="${totalPage > 1}">
                                        <li class="datatable-pagination-list-item ${currentPage == 1 ? 'datatable-hidden datatable-disabled' : ''}">
                                            <button data-page="${currentPage - 1}"
                                                ...
                                                <a href="/admin/material/view?page=${currentPage - 1}&search=${search}">‹</a>
                                            </button>
                                        </li>
                                    </c:if>
                                        ...
                                        <c:if test="${totalPage == 1 || i <= 5 || i >= totalPage - 4 || (i >= currentPage - 2 && i <= currentPage + 2)}">
                                            <li class="datatable-pagination-list-item ${i == currentPage ? 'datatable-active' : ''}">
                                                <button data-page="${i}" class="datatable-pagination-list-item-link"
                                                        aria-label="Page ${i}">
                                                    <a href="/admin/material/view?page=${i}&search=${search}">${i}</a>
                                                </button>
                                            </li>
                                        </c:if>
