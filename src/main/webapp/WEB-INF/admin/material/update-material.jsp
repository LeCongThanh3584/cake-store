    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-9 mx-auto col-md-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title text-center my-4 fs-1">Update material</h5>

                        <!-- Horizontal Form -->
                        <form action="/admin/material/update?id=${mt.id}" method="post">
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                        <textarea class="form-control" id="inputDescription"
                                                  name="description" value="${mt.description}"></textarea>
                                </div>
                            </div>
