    ...
    <div>
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item fs-5 active">Add material</li>
            </ol>
        </nav>
    </div>
    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-9 mx-auto col-md-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title text-center my-4 fs-1">New material</h5>
                        <form method="post" action="/admin/material/create">
                            <div class="row mb-3">
                                <label for="inputText" class="col-sm-2 col-form-label">Code</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="inputText" name="code">
                                </div>
                            </div>
                            <div class="row mb-3">
                            ...
                            <div class="text-center">
                                ...
                                <a href="/admin/material/view" class="btn btn-secondary fs-5 px-4">Back</a>
                            </div>
                        </form>
