    ...
    <div>
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item fs-5 active">View cake</li>
            </ol>
        </nav>
    </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <h3 class="card-title fs-3">List of cake</h3>
                            <a href="/admin/cake/create" class="btn btn-success text-white"><i
                                    class="bi bi-file-earmark-plus">Add cake</i></a>
                        </div>
                        <div class="datatable-top">
                            <form class="datatable-search text-end" action="/admin/cake/view">
                        ...
                        <table class="table datatable">
                            ...
                            <tbody>
                            <c:forEach items="${cakes}" var="ck" varStatus="i">
                                <tr>
                                    <td>${i.index + 1}</td>
                                    <td>${ck.code}</td>
                                    <td>${ck.name}</td>
                                    <td><img src="${ck.image}" height="100px" width="100px"></td>
                                    <td>${ck.category}</td>
                                    <td>${ck.createdBy}</td>
                                    <td>${ck.createdAt}</td>
                                    <td>
                                        <a class="btn btn-primary"
                                           href="/admin/cake/update?id=${ck.id}"><i
                                                class="bi bi-pencil-square"></i></a>
                                        <a class="btn btn-danger" href="#"
                                           onclick="confirmDeletion('/admin/cake/delete?id=${ck.id}')">
                                    ...
                                    <c:if test="${totalPage > 1}">
                                        <li class="datatable-pagination-list-item ${currentPage == 1 ? 'datatable-hidden datatable-disabled' : ''}">
                                            <button data-page="${currentPage - 1}"
                                                ...
                                                <a href="/admin/cake/view?page=${currentPage - 1}&search=${search}">‹</a>
                                            </button>
                                        </li>
                                    </c:if>
                                        ...
                                        <c:if test="${totalPage == 1 || i <= 5 || i >= totalPage - 4 || (i >= currentPage - 2 && i <= currentPage + 2)}">
                                            <li class="datatable-pagination-list-item ${i == currentPage ? 'datatable-active' : ''}">
                                                <button data-page="${i}" class="datatable-pagination-list-item-link"
                                                        aria-label="Page ${i}">
                                                    <a href="/admin/cake/view?page=${i}&search=${search}">${i}</a>
                                                </button>
                                            </li>
                                        </c:if>
