    ...
    <div>
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item fs-5 active">Delivering orders</li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <h3 class="card-title fs-3">List of your delivering orders</h3>

                            <div class="btn-group" role="group" aria-label="Basic radio toggle button group">
                                <a href="/shipper/view" class="btn btn-outline-primary">Available Orders</a>
                                <a class="btn btn-primary">Your orders</a>
                        ...
                        <table class="table datatable">
                            ...
                            <c:choose>
                                <c:when test="${orders.size() == 0}">
                                    <tr>
                                        <td colspan="8">
                                            <h2 class="mb-4">There is no order waiting for delivery</h2>
                                        </td>
                                    </tr>
                                </c:when>
                                <c:otherwise>
    ...
    <div class='modal-dialog'>
        <div class='modal-content'>
            <div class='modal-header'>
                <h1 class='modal-title fs-5' id='exampleModalLabel'>Confirm this delivery</h1>
                <button class='btn-close' data-bs-dismiss='modal' aria-label='Close'></button>
            </div>
            <form method='post' action="/shipper/deliver" class='modal-body'>
    ...
    if (exampleModal) {
        ...
        exampleModal.addEventListener('show.bs.modal', (event) => {
            ...
            modalBody.innerHTML = "" +
                ...
                "<input name='description' placeholder='A message for your store' value ='' class='form-control' id='shipperDesc' aria-describedby='description'>" +
